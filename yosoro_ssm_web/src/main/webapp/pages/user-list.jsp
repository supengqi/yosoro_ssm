									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findUserByIdAllRole.do?id=${user.id}" class="btn bg-olive btn-xs">添加角色</a>
												<a href="${pageContext.request.contextPath}/user/updateFindById.do?id=${user.id}" class="btn bg-olive btn-xs">修改用户</a>
												<a href="${pageContext.request.contextPath}/user/deleteUsers.do?id=${user.id}" class="btn bg-olive btn-xs">删除用户</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
